...
export function LandingStickyCTA() {
  ...
  return (
    <div 
      className={`fixed bottom-0 left-0 right-0 z-50 md:hidden bg-background/95 backdrop-blur-md border-t border-border px-4 py-3.5 flex items-center justify-between shadow-2xl transition-all duration-500 ease-out transform ${
