...
// Props top bar progres app yang dipakai ulang oleh dashboard dan halaman app lain.
export type AppProgressTopBarProps = {
  streakDays: number;
...
// Top bar app post-login untuk menampilkan badge, XP, streak, dan online indicator secara konsisten.
export function AppProgressTopBar({
  streakDays,
  currentJabatan,
  currentGolongan,
  currentBadge,
